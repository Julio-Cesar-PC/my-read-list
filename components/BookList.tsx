          ...
          <div className="flex flex-col gap-2">
           ...
           <div className="flex flex-row gap-2">
            ...
            <div className="max-w-xs mt-4">
              ...
              <input type="number" max={bookModal?.volumeInfo?.pageCount} id="paginas" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            </div>
